...
public class ExcelReader {
    ...
    // No more direct file handling here

    public static List<Map<String, String>> getAllSheetData(String sheetName) {
        List<Map<String, String>> listData = new ArrayList<>();

        Workbook workbook = TestDataStore.getWorkbook();
        if (workbook == null) {
            throw new IllegalStateException(
                    "Excel workbook is not initialized. Ensure @Before hook ran."
            );
        }
        ...
        if (sheet == null) {
            ...
            throw new RuntimeException("Sheet '" + sheetName + "' was NOT found in workbook. "
    ...
    public static Map<String, String> readExcelData(String sheetName, String scenarioName) {
